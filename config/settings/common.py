# -*- coding: utf-8 -*-
"""
Django settings for finhack_bca project.
...
APPS_DIR = ROOT_DIR.path('finhack_bca')
...
LOCAL_APPS = (
    'finhack_bca.users',  # custom users app
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'finhack_bca.contrib.sites.migrations'
}
...
SOCIALACCOUNT_ADAPTER = 'finhack_bca.users.adapters.SocialAccountAdapter'
...
# default serializer, which is JSON, does not support objects
